                ...
                <table class="table">
                    ...
                    <tbody class="table__body">
                        <template v-for="item in items" :key="item.id">
                            <tr class="table__body-row" @click="openClientData(item)">
                                <td class="table__body-cell" v-for="header in headers" :key="header.key">
                                    {{ item[header.key] }}
                                </td>
                                <div class="button-wrapper">
                                    <button class="row-button" @click.stop="openEditDialog(item)">
                                        <font-awesome-icon class="row-icon" icon="pen-to-square" />
                                    </button>
                                    <button class="row-button" @click.stop="openDeleteDialog(item)">
...
export default {
    ...
    emits: ['editItem', 'deleteItem', 'openClientData'],
